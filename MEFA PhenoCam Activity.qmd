...
If you'd like, now try this exercise with another PhenoCam site. Be sure to either clear your working directory folder (delete the downloaded photos/files) or create/designate a new folder directory before trying a new site. And run this command to re-set your plotting parameters:
