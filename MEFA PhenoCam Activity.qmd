...
As an example, here's the gif I made for the lacclair site. Your gif will be saved to the directory you indicated at the beginning (called "dir").

<img src="images/MonthlyGreenness_gif.gif" align="left" width="750"/>/

#### Thank you!

If you'd like, now try this exercise with another PhenoCam site. Perhaps try a different ecosystem type!

Before trying a new site, be sure to either clear your working directory folder (delete the downloaded photos/files) or create/designate a new folder. And run this command to re-set your plotting parameters:
